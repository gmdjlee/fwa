...
**최종 갱신:** 2026-07-25 밤 11차 (**#12 합치 게이트 실기기 G1~G5 전부 통과** — 9 세션 9/9 done. G1 엔드스크린 conf 0.70 쓰레기 차단(BOTH_AXES_BARS)·G2 컨트롤 오염 snap 1.5 차단(NO_BARS_INCONSISTENT)·G3 **3/3 SNAP_AGREE→MEASURED 채택** residual=0 4.2~4.3s·G4 ADAPTIVE 5회 생존·G5 tier 0 완전 작동(divider 928). 현장 수정 2건: `toPillarboxScan` sideMarginPct 0.005(최외곽 열 var 404~501 물증) + edgeMarginPct 0.12·`classifyAxis` minConfidence(플레이어 크롬 결정론 오염 물증). 도메인 상수 무변경. 테스트 186. DEVICE_FACTS 11차 절 = SSOT. 미커밋)
**현재 Phase:** Phase 3 진행 중 — P3-1·P3-2·P3-3·P3-4 완료, 잔여 P3-5
**다음 행동 (착수 목록):**
1. 측정 캐싱 재검토 (DESIGN_12 §6, admission = 합치∧verified — 차단 해제됨). P3-5 FoldingFeature
