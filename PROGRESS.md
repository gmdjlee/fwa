...
| **W3** 기하 정합성·도메인 불변식 (F2 1단계·F1) | ✅ **완료** (`8edcce3`) | 0.5회 **[미검증]** |
| **W4** 테스트 안전망 (T1) | ✅ **완료** (`0f53af2`) | 불필요 |
| **W5** 구동부 안정화 (F6·F9) | ✅ **완료** (`70e53fa`) | 1회 **[미검증]** |
| **W6** 세션 상태 캡슐화 (M1 1단계) ⚠ 최대 위험·단독 커밋 | ✅ **완료** (`836efe0`) | 1회 **[미검증]** |
