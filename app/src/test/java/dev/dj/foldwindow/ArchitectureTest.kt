...
/**
 * T2 (docs/IMPROVEMENT_PLAN_2026-07-29.md §1, docs/CODE_REVIEW_2026-07-29.md T2): CLAUDE.md 의
 * "철칙 — `domain/` 에 `import android.*` 이 들어가면 리뷰 거부" 를 기계화한다. 지금까지는 사람의
 * 리뷰에만 의존했다(실제로는 잘 지켜지고 있음 — CODE_REVIEW 2026-07-29 확인: 0건).
 *
